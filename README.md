...
self.asset.get_model_path(use_inference_path=False)     
self.asset.get_report_path() 
...
```
cd existing_repo
git remote add origin http://mod.lge.com/hub/smartdata/ml-framework/alov2.git
git branch -M main
...
- [ ] [Set up project integrations](http://mod.lge.com/hub/smartdata/ml-framework/alov2/-/settings/integrations)
